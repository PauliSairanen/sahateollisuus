...
export default class MapsComponent extends React.Component {
    ...
    constructor(){  
        ...
        this.state = {  
                ...
                locerror: null  ,
                locmapc:{lng:this.data.mainplace.lng,lat:this.data.mainplace.lat},
                MapboxGL: MapboxGL
            }
    ...
    this.setState({  
        ...
        locmapc: {lng: position.coords.longitude , lat: position.coords.latitude}
    });
    };
    ...
    renderAnnotationsloca(lngg,latt) {
		...
		return (
                ...
                <MapboxGL.PointAnnotation
                    key="here"
                    id="here"
                    coordinate={[this.state.locmapc.lng,this.state.locmapc.lat]}>
                    <View style={styles2.annotationContainerWhite}>
                        <View style={styles2.annotationFillWhite} />
                    </View>
                    <MapboxGL.Callout title="here" />
                </MapboxGL.PointAnnotation>
		);
	}	
  ...
  render() {
      //this.data=DATAPLACES;
      //this.setState({locmapc:{lng:this.data.mainplace.lng,lat:this.data.mainplace.lat}});
             ...
             <View style={styles2.map2}>
                ...
                <View >
                    <MapboxGL.MapView style={styles2.map2}>
                        ...
                        {this.renderAnnotationsloca(this.data.mainplace.lng,this.data.mainplace.lat)}
